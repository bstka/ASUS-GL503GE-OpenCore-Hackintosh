...
### Known Bug
1. Audio Combo Jack is working but the sound is terrible/sluggish, still searching for so
...
3. All function keys are not functional, still searching for solution