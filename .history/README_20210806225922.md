...
### Known Bug
1. Audio Combo Jack is working but the sound is terrible/sluggish
2. When use HDMI Build-in display goes black af ter unplug keep goes black. __Solution: Put laptop sleep first before using HDMI__
